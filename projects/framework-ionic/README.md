...
[![npm version](https://img.shields.io/npm/v/@richie696%2Fangular-framework-ionic?logo=npm&label=npm)](https://www.npmjs.com/package/@richie696/angular-framework-ionic)
[![npm downloads](https://img.shields.io/npm/dm/@richie696%2Fangular-framework-ionic?logo=npm&label=downloads)](https://www.npmjs.com/package/@richie696/angular-framework-ionic)
...
当前发布版本为 `1.0.2`。本包只负责 Ionic 适配，通用请求、URL、存储和并发能力请从 `@richie696/angular-framework` 引入。
